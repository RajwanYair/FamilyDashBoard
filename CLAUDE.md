# CLAUDE.md — FamilyDashBoard v8.8.0
...
tests/unit/            # Vitest — 3205+ tests / 95 suites
sw.ts                  # ServiceWorker source v8.8.0 (compiled to dist/sw.js via scripts/build-sw.mjs)
