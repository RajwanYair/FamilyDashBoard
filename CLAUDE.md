# CLAUDE.md — FamilyDashBoard v7.11.0
...
- Tests: `npx vitest run` (2332 tests, 55 suites, 0 failures)
- SW: `sw.js` v7.11.0 (offline + API cache)
...
tests/unit/            # Vitest — 2287 tests / 54 suites
sw.js                  # ServiceWorker v7.11.0
