# CLAUDE.md — FamilyDashBoard v10.0.0
...
tests/unit/            # Vitest — 3193 tests / 94 suites
sw.ts                  # ServiceWorker source v10.0.0 (compiled to dist/sw.js via scripts/build-sw.mjs)
