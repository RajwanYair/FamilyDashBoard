# CLAUDE.md — FamilyDashBoard v11.0.0
...
tests/unit/            # Vitest — 3249 tests / 98 suites
sw.ts                  # ServiceWorker source v11.0.0 (compiled to dist/sw.js via scripts/build-sw.mjs)
