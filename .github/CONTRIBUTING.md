...
**Thresholds** (canonical source: `vitest.config.ts`): statements 95.7%, branches 88.8%, functions 95.1%, lines 96.7%. The thresholds ratchet upward each sprint as targeted tests are added — see Roadmap #8.
