...
**Thresholds** (canonical source: `vitest.config.ts`): statements 94.2%, branches 85.4%, functions 94.5%, lines 95.6%. The thresholds ratchet upward each sprint as targeted tests are added — see Roadmap #8.
