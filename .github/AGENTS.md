...
### `@dashboard-designer`
UI/UX specialist — CSS custom properties, RTL layout, TV readability, 5 themes, 3 screen modes, glassmorphism, card animations.
...
| `/update-tests` | add tests, fix failing tests, test suite | Add/update regex-based HTML/CSS/JS tests |
