...
# FamilyDashBoard — v14.30.0

TypeScript modular TV dashboard · Vite 8 + TS 6.0.3 + Vitest 4.1.5 · Hebrew RTL · Zero external CDN dependencies · 1920×1080+ always-on display · 7 themes · 3 screen modes · 12 cards
...
> **Tests**: 7517 / 308 suites / 0 failures · **Lint**: 0 errors · 0 warnings · 0 suppressions
> **Coverage**: 96.44 / 89.70 / 95.81 / 97.41 (statements / branches / functions / lines) — see `vitest.config.ts`
