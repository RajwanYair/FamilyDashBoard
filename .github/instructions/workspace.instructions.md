...
> **Tests**: 2931+ / 79 suites / 0 failures · **Lint**: 0 errors · 0 warnings · 0 suppressions
...
tests/unit/                 # Vitest unit tests — 2931+ tests / 79 suites
sw.js                       # ServiceWorker v7.19.0 (offline + API cache)
