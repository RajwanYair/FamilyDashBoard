...
> **Tests**: 2853+ / 73 suites / 0 failures · **Lint**: 0 errors · 0 warnings · 0 suppressions
...
tests/unit/                 # Vitest unit tests — 2853+ tests / 73 suites
sw.js                       # ServiceWorker v7.18.0 (offline + API cache)
