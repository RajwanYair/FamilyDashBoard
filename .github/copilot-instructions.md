# GitHub Copilot Instructions — FamilyDashBoard v14.11.0
...
> Tests: `npx vitest run` — 7135 / 282 suites / 0 failures
> Lint: `npx eslint src tests --max-warnings 0` — 0 errors · 0 warnings · 0 suppressions
> Coverage thresholds: `95.0 / 87.0 / 94.8 / 96.0` (statements / branches / functions / lines) — see `vitest.config.ts`
...
40. **Browser support** — `.browserslistrc` targets Chrome 114+ · Edge 114+ · Firefox 128+ · Firefox ESR · Safari 17.4+ · Opera 100+ · Samsung 23+ · iOS 17.4+ · Android 114+ · ChromeAndroid 114+ · FirefoxAndroid 128+ · OperaMobile 80+. CSS features must be compatible with all these (see `.hintrc`). Playwright smoke + a11y tests run on all projects; visual regression runs on chromium only.
