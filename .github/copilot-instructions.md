# GitHub Copilot Instructions — FamilyDashBoard v13.29.0
...
> Tests: `npx vitest run` — 5701 / 170 suites / 0 failures
> Lint: `npx eslint src tests --max-warnings 0` — 0 errors · 0 warnings · 0 suppressions
> Coverage thresholds: `92.7 / 84.2 / 91.5 / 94.0` (statements / branches / functions / lines) — see `vitest.config.ts`
