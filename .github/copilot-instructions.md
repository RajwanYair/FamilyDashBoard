# GitHub Copilot Instructions — FamilyDashBoard v14.1.0
...
> Tests: `npx vitest run` — 6240 / 203 suites / 0 failures
> Lint: `npx eslint src tests --max-warnings 0` — 0 errors · 0 warnings · 0 suppressions
> Coverage thresholds: `93.4 / 84.9 / 92.1 / 94.8` (statements / branches / functions / lines) — see `vitest.config.ts`
