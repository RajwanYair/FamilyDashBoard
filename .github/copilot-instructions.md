# GitHub Copilot Instructions — FamilyDashBoard v14.16.0
...
> Tests: `npx vitest run` — 7331 / 287 suites / 0 failures
> Lint: `npx eslint src tests --max-warnings 0` — 0 errors · 0 warnings · 0 suppressions
> Coverage thresholds: `96.4 / 89.5 / 95.7 / 97.4` (statements / branches / functions / lines) — see `vitest.config.ts`
