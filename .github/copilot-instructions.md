# GitHub Copilot Instructions — FamilyDashBoard v14.19.0
...
> Tests: `npx vitest run` — 7338 / 287 suites / 0 failures
> Lint: `npx eslint src tests --max-warnings 0` — 0 errors · 0 warnings · 0 suppressions
> Coverage thresholds: `96.5 / 89.7 / 95.7 / 97.4` (statements / branches / functions / lines) — see `vitest.config.ts`
