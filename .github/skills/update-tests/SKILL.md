...
- **Coverage**: `npx vitest run --coverage` → repo thresholds 93.0 / 84.6 / 92.0 / 94.5 (statements / branches / functions / lines), canonical source `vitest.config.ts`. Target ≥95% per file when adding new modules.
