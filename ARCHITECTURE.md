...
| Test framework | **Vitest 4 + happy-dom**                                        | Vite-native, real DOM simulation, 2853+ tests / 73 suites       |
...
15. **2853+ tests / 73 suites / 0 failures** — coverage thresholds: 90% statements, 81% branches, 90% functions, 92% lines (v7.18)
