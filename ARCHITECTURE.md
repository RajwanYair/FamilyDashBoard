...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 3188 tests / 95 suites      |
...
15. **3188 tests / 95 suites / 0 failures** — coverage thresholds: 90% statements, 81% branches, 90% functions, 92% lines (v9.1.0)
