# FamilyDashBoard — Architecture (v13.0.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                                    | Vite-native, real DOM simulation, 4148 tests / 142 suites      |
...
15. **4021 tests / 135 suites / 0 failures** — coverage thresholds: 86% statements, 77% branches, 84% functions, 87% lines (v12.9.0)
