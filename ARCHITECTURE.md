# FamilyDashBoard — Architecture (v8.1.0)
...
| Test framework | **Vitest 4 + happy-dom**                                        | Vite-native, real DOM simulation, 3053+ tests / 87 suites       |
...
15. **3080 tests / 88 suites / 0 failures** — coverage thresholds: 90% statements, 81% branches, 90% functions, 92% lines (v8.1.0)
