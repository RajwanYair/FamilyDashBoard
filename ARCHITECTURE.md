# FamilyDashBoard — Architecture (v7.21.0)
...
| Test framework | **Vitest 4 + happy-dom**                                        | Vite-native, real DOM simulation, 2998+ tests / 86 suites       |
...
15. **3003+ tests / 87 suites / 0 failures** — coverage thresholds: 90% statements, 81% branches, 90% functions, 92% lines (v7.21.0)
