# FamilyDashBoard — Architecture (v13.1.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                                    | Vite-native, real DOM simulation, 4522 tests / 152 suites      |
...
15. **4522 tests / 152 suites / 0 failures** — coverage thresholds: 88% statements, 80% branches, 88% functions, 90% lines (v13.4.0)
