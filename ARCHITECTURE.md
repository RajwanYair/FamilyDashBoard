...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                                    | Vite-native, real DOM simulation, 3459 tests / 109 suites      |
...
15. **3459 tests / 109 suites / 0 failures** — coverage thresholds: 94% statements, 88% branches, 94% functions, 95% lines (v12.2.0)
