# FamilyDashBoard — Architecture (v9.2.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 3193 tests / 94 suites      |
...
15. **3193 tests / 94 suites / 0 failures** — coverage thresholds: 90% statements, 81% branches, 90% functions, 92% lines (v9.2.0)
