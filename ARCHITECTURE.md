# FamilyDashBoard — Architecture (v12.7.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                                    | Vite-native, real DOM simulation, 3775 tests / 127 suites      |
...
15. **3775 tests / 127 suites / 0 failures** — coverage thresholds: 86% statements, 77% branches, 84% functions, 87% lines (v12.7.0)
