...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                                    | Vite-native, real DOM simulation, 3406 tests / 106 suites      |
...
15. **3406 tests / 106 suites / 0 failures** — coverage thresholds: 94% statements, 88% branches, 94% functions, 95% lines (v12.1.0)
