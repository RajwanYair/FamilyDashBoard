# FamilyDashBoard — Architecture (v11.0.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 3249 tests / 98 suites      |
...
15. **3249 tests / 98 suites / 0 failures** — coverage thresholds: 92% statements, 85% branches, 92% functions, 94% lines (v11.0.0)
