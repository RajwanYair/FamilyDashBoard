# FamilyDashBoard — Architecture (v14.2.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 6303 tests / 205 suites     |
...
15. **6303 tests / 205 suites / 0 failures** — coverage thresholds: 93.9% statements, 85.1% branches, 94.2% functions, 95.3% lines (v14.2.0)
