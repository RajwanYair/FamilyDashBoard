...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 5137 tests / 162 suites     |
...
15. **5137 tests / 162 suites / 0 failures** — coverage thresholds: 93.5% statements, 85.5% branches, 92.5% functions, 94.7% lines (v13.17.0)
