# FamilyDashBoard — Architecture (v13.17.0)
...
15. **5155 tests / 162 suites / 0 failures** — coverage thresholds: 93.5% statements, 85.7% branches, 92.5% functions, 94.7% lines (v13.18.0)
