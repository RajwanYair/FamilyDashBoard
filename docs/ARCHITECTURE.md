# FamilyDashBoard — Architecture (v14.16.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 7307 tests / 287 suites     |
...
15. **7307 tests / 287 suites / 0 failures** — coverage thresholds: 96.0% statements, 89.2% branches, 95.2% functions, 97.0% lines
