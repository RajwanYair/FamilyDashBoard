# FamilyDashBoard — Architecture (v13.30.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 5872 tests / 172 suites     |
...
15. **5872 tests / 172 suites / 0 failures** — coverage thresholds: 93.0% statements, 84.6% branches, 92.0% functions, 94.5% lines (v13.30.0)
