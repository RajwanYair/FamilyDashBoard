# FamilyDashBoard — Architecture (v13.14.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 4835 tests / 157 suites     |
...
15. **4802 tests / 154 suites / 0 failures** — coverage thresholds: 89% statements, 81% branches, 89% functions, 90% lines (v13.8.0)
