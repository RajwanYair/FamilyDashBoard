# FamilyDashBoard — Architecture (v14.4.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 6361 tests / 212 suites     |
...
15. **6361 tests / 212 suites / 0 failures** — coverage thresholds: 94.2% statements, 85.4% branches, 94.5% functions, 95.6% lines (v14.4.0)
