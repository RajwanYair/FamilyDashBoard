# FamilyDashBoard — Architecture (v14.25.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 7549+ tests / 313 suites    |
...
15. **7549+ tests / 313 suites / 0 failures** — coverage thresholds: 96.5% statements, 89.8% branches, 95.9% functions, 97.5% lines
