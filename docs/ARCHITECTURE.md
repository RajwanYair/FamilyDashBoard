# FamilyDashBoard — Architecture (v14.17.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 7331 tests / 287 suites     |
...
15. **7331 tests / 287 suites / 0 failures** — coverage thresholds: 96.4% statements, 89.5% branches, 95.7% functions, 97.4% lines
