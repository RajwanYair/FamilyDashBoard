# FamilyDashBoard — Architecture (v14.1.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 6240 tests / 203 suites     |
...
15. **6240 tests / 203 suites / 0 failures** — coverage thresholds: 93.4% statements, 84.9% branches, 92.1% functions, 94.8% lines (v14.1.0)
