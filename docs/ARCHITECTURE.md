# FamilyDashBoard — Architecture (v14.14.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 7252 tests / 282 suites     |
...
15. **7252 tests / 282 suites / 0 failures** — coverage thresholds: 95.9% statements, 88.9% branches, 95.2% functions, 96.9% lines
