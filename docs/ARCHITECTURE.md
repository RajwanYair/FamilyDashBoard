...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 7542+ tests / 313 suites    |
...
15. **7542+ tests / 313 suites / 0 failures** — coverage thresholds: 96.4% statements, 89.7% branches, 95.8% functions, 97.4% lines
