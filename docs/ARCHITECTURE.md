# FamilyDashBoard — Architecture (v14.32.0)
...
| Test framework   | **Vitest 4.1.6 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 7669+ tests / 319 suites    |
...
15. **7631+ tests / 316 suites / 0 failures** — coverage thresholds: 97.1% statements, 90.54% branches, 96.46% functions, 98.13% lines
