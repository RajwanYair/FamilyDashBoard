# FamilyDashBoard — Architecture (v14.7.0)
...
15. **7050 tests / 277 suites / 0 failures** — coverage thresholds: 94.4% statements, 85.6% branches, 94.7% functions, 95.8% lines (v14.7.0)
