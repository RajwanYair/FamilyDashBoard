# FamilyDashBoard — Architecture (v14.5.0)
...
15. **7037 tests / 275 suites / 0 failures** — coverage thresholds: 94.4% statements, 85.6% branches, 94.7% functions, 95.8% lines (v14.5.0)
