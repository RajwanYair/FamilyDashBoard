# FamilyDashBoard — Architecture (v13.20.0)
...
| Test framework   | **Vitest 4.1.5 + happy-dom 20**                                                                            | Vite-native, real DOM simulation, 5256 tests / 164 suites     |
...
15. **5256 tests / 164 suites / 0 failures** — coverage thresholds: 93.5% statements, 85.7% branches, 92.5% functions, 94.7% lines (v13.20.0)
