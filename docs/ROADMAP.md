...
| 18  | Enhance  | Visual-regression baselines 54 → 80+ (DO-SSE + video-news + maximise-FLIP + 21-day cal + 4×2 wx)    | P1  | M   | Mid | v14.0   | Sprint 154: 18 → 30 test scenarios (config-panel · maximised-card · help-dialog · diag-overlay states added). 30×3-OS = 90 baseline files. |
