...
export const hebrewCalConfigSchema: CardConfigField[] = [
  ...
  {
    key: "hcalShowOmer",
    labelHe: "הצג ספירת העומר",
    labelEn: "Show Omer count",
    type: "boolean",
    defaultValue: true,
    group: "תצוגה",
  },
  {
    key: "hcalShowCandleLight",
    labelHe: "הצג הדלקת נרות",
    labelEn: "Show candle-lighting time",
    type: "boolean",
    defaultValue: true,
    group: "תצוגה",
  },
  {
    key: "hcalShowHaftarah",
    labelHe: "הצג הפטרה",
    labelEn: "Show Haftarah",
    type: "boolean",
    defaultValue: true,
    group: "תצוגה",
  },
  {
    key: "hcalShowRoshChodesh",
    labelHe: "הצג ראש חודש",
    labelEn: "Show Rosh Chodesh",
    type: "boolean",
    defaultValue: true,
    group: "תצוגה",
  },
  {
    key: "hcalZmanimMask",
    labelHe: "פילטר זמני יום",
    labelEn: "Zmanim items to show",
    type: "select",
    defaultValue: "all",
    options: [
      { value: "all", label: "הכל / All" },
      { value: "main", label: "עיקריים / Main" },
